...
function MainApp() {
  ...
  if (!isMounted || authLoading || projectsLoading || settingsLoading) {
    return (
      <div className="min-h-screen w-full bg-gradient-to-b from-[#0b0e13] via-[#0b0e13] to-[#0f1220] text-slate-200 antialiased flex items-center justify-center">
  ...
  return (
    <ErrorBoundary>
      <div className="min-h-screen w-full bg-gradient-to-b from-[#0b0e13] via-[#0b0e13] to-[#0f1220] text-slate-200 antialiased">
        <Header
